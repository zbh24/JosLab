...
mem_init(void)
{
	...
	boot_map_region(kern_pgdir,UPAGES,npages * sizeof(struct PageInfo),PADDR(pages),PTE_U);	// 用户可以读
	...
	// boot_map_region(kern_pgdir,KSTACKTOP-PTSIZE,PTSIZE-KSTKSIZE,naer,PTE_P);
...
mem_init_mp(void)
{
	...
	//boot_map_region(kern_pgdir,MMIOBASE,KSTKSIZE,PADDR(bootstack),PTE_W);
