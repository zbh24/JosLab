...
libmain(int argc, char **argv)
{
  ...
  800051:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	// set thisenv to point at our Env structure in envs[].
	// LAB 3: Your code here.
	thisenv = 0;
  800054:	c7 05 04 20 80 00 00 	movl   $0x0,0x802004
  80005b:	00 00 00 
	thisenv = &envs[ENVX(sys_getenvid())];
  80005e:	e8 53 03 00 00       	call   8003b6 <sys_getenvid>
...
exit(void)
{
  ...
  8000a8:	e8 3d 03 00 00       	call   8003ea <sys_env_destroy>
}
  8000ad:	c9                   	leave  
  8000ae:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000b5:	89 1c 24             	mov    %ebx,(%esp)
  8000b8:	89 74 24 04          	mov    %esi,0x4(%esp)
  8000bc:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
...
sys_ipc_recv(void *dstva)
{
  ...
  800119:	83 ec 38             	sub    $0x38,%esp
  80011c:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80011f:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800122:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80012a:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  80013c:	7e 28                	jle    800166 <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80013e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800142:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800149:	00 
  80014a:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  800151:	00 
  800152:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800159:	00 
  80015a:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  800161:	e8 e1 02 00 00       	call   800447 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800166:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800169:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80016c:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80016f:	89 ec                	mov    %ebp,%esp
  800171:	5d                   	pop    %ebp
  800172:	c3                   	ret    

00800173 <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800180:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80019c:	8b 1c 24             	mov    (%esp),%ebx
  80019f:	8b 74 24 04          	mov    0x4(%esp),%esi
  8001a3:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8001a7:	89 ec                	mov    %ebp,%esp
  8001a9:	5d                   	pop    %ebp
  8001aa:	c3                   	ret    

008001ab <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8001ae:	83 ec 38             	sub    $0x38,%esp
  8001b1:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8001b4:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8001b7:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8001bf:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8001d2:	7e 28                	jle    8001fc <sys_env_set_pgfault_upcall+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001d4:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001d8:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8001df:	00 
  8001e0:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  8001e7:	00 
  8001e8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ef:	00 
  8001f0:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  8001f7:	e8 4b 02 00 00       	call   800447 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800230:	7e 28                	jle    80025a <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800232:	89 44 24 10          	mov    %eax,0x10(%esp)
  800236:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80023d:	00 
  80023e:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  800245:	00 
  800246:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80024d:	00 
  80024e:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  800255:	e8 ed 01 00 00       	call   800447 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80028e:	7e 28                	jle    8002b8 <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800290:	89 44 24 10          	mov    %eax,0x10(%esp)
  800294:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80029b:	00 
  80029c:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  8002a3:	00 
  8002a4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002ab:	00 
  8002ac:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  8002b3:	e8 8f 01 00 00       	call   800447 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002d1:	89 7d fc             	mov    %edi,-0x4(%ebp)
	...
	asm volatile("int %1\n"
  8002d4:	b8 05 00 00 00       	mov    $0x5,%eax
  8002d9:	8b 75 18             	mov    0x18(%ebp),%esi
  8002dc:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  8002ec:	7e 28                	jle    800316 <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002ee:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002f2:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8002f9:	00 
  8002fa:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  800301:	00 
  800302:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800309:	00 
  80030a:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  800311:	e8 31 01 00 00       	call   800447 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80034b:	7e 28                	jle    800375 <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  80034d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800351:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800358:	00 
  800359:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  800360:	00 
  800361:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800368:	00 
  800369:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  800370:	e8 d2 00 00 00       	call   800447 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800375:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800378:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80037b:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_yield(void)
{
  ...
  800388:	89 1c 24             	mov    %ebx,(%esp)
  80038b:	89 74 24 04          	mov    %esi,0x4(%esp)
  80038f:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800398:	b8 0a 00 00 00       	mov    $0xa,%eax
  80039d:	89 d1                	mov    %edx,%ecx
  80039f:	89 d3                	mov    %edx,%ebx
  8003a1:	89 d7                	mov    %edx,%edi
  8003a3:	89 d6                	mov    %edx,%esi
...
sys_yield(void)
{
  ...
  8003a7:	8b 1c 24             	mov    (%esp),%ebx
  8003aa:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003ae:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003b2:	89 ec                	mov    %ebp,%esp
  8003b4:	5d                   	pop    %ebp
  8003b5:	c3                   	ret    

008003b6 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  8003bc:	89 1c 24             	mov    %ebx,(%esp)
  8003bf:	89 74 24 04          	mov    %esi,0x4(%esp)
  8003c3:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003cc:	b8 02 00 00 00       	mov    $0x2,%eax
  8003d1:	89 d1                	mov    %edx,%ecx
  8003d3:	89 d3                	mov    %edx,%ebx
...
sys_getenvid(void)
{
  ...
  8003db:	8b 1c 24             	mov    (%esp),%ebx
  8003de:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003e2:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003e6:	89 ec                	mov    %ebp,%esp
  8003e8:	5d                   	pop    %ebp
  8003e9:	c3                   	ret    

008003ea <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  8003ed:	83 ec 38             	sub    $0x38,%esp
  8003f0:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8003f3:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8003f6:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003fe:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  800410:	7e 28                	jle    80043a <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  800412:	89 44 24 10          	mov    %eax,0x10(%esp)
  800416:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80041d:	00 
  80041e:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  800425:	00 
  800426:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80042d:	00 
  80042e:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  800435:	e8 0d 00 00 00       	call   800447 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  80043a:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80043d:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800440:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
void
_panic(const char *file, int line, const char *fmt, ...)
  80044f:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
  ...
  800452:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800458:	e8 59 ff ff ff       	call   8003b6 <sys_getenvid>
  80045d:	8b 55 0c             	mov    0xc(%ebp),%edx
  800460:	89 54 24 10          	mov    %edx,0x10(%esp)
  800464:	8b 55 08             	mov    0x8(%ebp),%edx
  800467:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80046b:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80046f:	89 44 24 04          	mov    %eax,0x4(%esp)
  800473:	c7 04 24 98 12 80 00 	movl   $0x801298,(%esp)
  80047a:	e8 7f 00 00 00       	call   8004fe <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80047f:	89 74 24 04          	mov    %esi,0x4(%esp)
  800483:	8b 45 10             	mov    0x10(%ebp),%eax
  800486:	89 04 24             	mov    %eax,(%esp)
  800489:	e8 0f 00 00 00       	call   80049d <vcprintf>
	cprintf("\n");
  80048e:	c7 04 24 bc 12 80 00 	movl   $0x8012bc,(%esp)
  800495:	e8 64 00 00 00       	call   8004fe <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80049a:	cc                   	int3   
  80049b:	eb fd                	jmp    80049a <_panic+0x53>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004a0:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  8004bd:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8004c1:	8b 45 08             	mov    0x8(%ebp),%eax
  8004c4:	89 44 24 08          	mov    %eax,0x8(%esp)
  8004c8:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  8004ce:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004d2:	c7 04 24 18 05 80 00 	movl   $0x800518,(%esp)
  8004d9:	e8 cf 01 00 00       	call   8006ad <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8004de:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8004e4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004e8:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8004ee:	89 04 24             	mov    %eax,(%esp)
  8004f1:	e8 ed fb ff ff       	call   8000e3 <sys_cputs>

	return b.cnt;
}
  8004f6:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  8004fc:	c9                   	leave  
  8004fd:	c3                   	ret    
  ...
  800504:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  800511:	e8 87 ff ff ff       	call   80049d <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  80051f:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  800522:	8b 03                	mov    (%ebx),%eax
  800524:	8b 55 08             	mov    0x8(%ebp),%edx
  800527:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  80052b:	83 c0 01             	add    $0x1,%eax
  80052e:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800530:	3d ff 00 00 00       	cmp    $0xff,%eax
  800535:	75 19                	jne    800550 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800537:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  80053e:	00 
  80053f:	8d 43 08             	lea    0x8(%ebx),%eax
  800542:	89 04 24             	mov    %eax,(%esp)
  800545:	e8 99 fb ff ff       	call   8000e3 <sys_cputs>
		b->idx = 0;
  80054a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
