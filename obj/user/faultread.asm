	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800261:	0f be 80 88 12 80 00 	movsbl 0x801288(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800345:	ff 24 95 40 13 80 00 	jmp    *0x801340(,%edx,4)
  ...
  800447:	c7 44 24 08 a2 12 80 	movl   $0x8012a2,0x8(%esp)
  80044e:	00 
  ...
  800481:	b8 a5 12 80 00       	mov    $0x8012a5,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800c94:	00 
  800c95:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800c9c:	00 
  800c9d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca4:	00 
  800ca5:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d2a:	00 
  800d2b:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800d32:	00 
  800d33:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3a:	00 
  800d3b:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800de6:	00 
  800de7:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800dee:	00 
  800def:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df6:	00 
  800df7:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e44:	00 
  800e45:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800e4c:	00 
  800e4d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e54:	00 
  800e55:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ea3:	00 
  800ea4:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800eab:	00 
  800eac:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eb3:	00 
  800eb4:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800f68:	00 
  800f69:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800f70:	00 
  800f71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f78:	00 
  800f79:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800fbe:	c7 04 24 f0 14 80 00 	movl   $0x8014f0,(%esp)
  ...
  800fd4:	e8 e4 f0 ff ff       	call   8000bd <vcprintf>
	cprintf("\n");
  800fd9:	c7 04 24 7c 12 80 00 	movl   $0x80127c,(%esp)
