...
forkchild(const char *cur, char branch)
{
  ...
  800039:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80003c:	89 75 fc             	mov    %esi,-0x4(%ebp)
  80003f:	8b 5d 08             	mov    0x8(%ebp),%ebx
  800042:	0f b6 75 0c          	movzbl 0xc(%ebp),%esi
	char nxt[DEPTH+1];

	if (strlen(cur) >= DEPTH)
  800046:	89 1c 24             	mov    %ebx,(%esp)
  800049:	e8 22 08 00 00       	call   800870 <strlen>
  80004e:	83 f8 02             	cmp    $0x2,%eax
  800051:	7f 41                	jg     800094 <forkchild+0x61>
		return;

	snprintf(nxt, DEPTH+1, "%s%c", cur, branch);
  800053:	89 f0                	mov    %esi,%eax
  800055:	0f be f0             	movsbl %al,%esi
  800058:	89 74 24 10          	mov    %esi,0x10(%esp)
  80005c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  800060:	c7 44 24 08 60 13 80 	movl   $0x801360,0x8(%esp)
  800067:	00 
  800068:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
  80006f:	00 
  800070:	8d 45 f4             	lea    -0xc(%ebp),%eax
  800073:	89 04 24             	mov    %eax,(%esp)
  800076:	e8 9b 07 00 00       	call   800816 <snprintf>
	if (fork() == 0) {
  80007b:	e8 e4 0f 00 00       	call   801064 <fork>
  800080:	85 c0                	test   %eax,%eax
  800082:	75 10                	jne    800094 <forkchild+0x61>
		forktree(nxt);
  800084:	8d 45 f4             	lea    -0xc(%ebp),%eax
  800087:	89 04 24             	mov    %eax,(%esp)
  80008a:	e8 0f 00 00 00       	call   80009e <forktree>
		exit();
  80008f:	e8 c0 00 00 00       	call   800154 <exit>
	}
}
  800094:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800097:	8b 75 fc             	mov    -0x4(%ebp),%esi
  80009a:	89 ec                	mov    %ebp,%esp
  80009c:	5d                   	pop    %ebp
  80009d:	c3                   	ret    
...
forktree(const char *cur)
{
  ...
  8000a5:	8b 5d 08             	mov    0x8(%ebp),%ebx
	cprintf("%04x: I am '%s'\n", sys_getenvid(), cur);
  8000a8:	e8 04 0f 00 00       	call   800fb1 <sys_getenvid>
  8000ad:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8000b1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8000b5:	c7 04 24 65 13 80 00 	movl   $0x801365,(%esp)
  8000bc:	e8 08 01 00 00       	call   8001c9 <cprintf>

	forkchild(cur, '0');
  8000c1:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  8000c8:	00 
  8000c9:	89 1c 24             	mov    %ebx,(%esp)
  8000cc:	e8 62 ff ff ff       	call   800033 <forkchild>
	forkchild(cur, '1');
  8000d1:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  8000d8:	00 
  8000d9:	89 1c 24             	mov    %ebx,(%esp)
  8000dc:	e8 52 ff ff ff       	call   800033 <forkchild>
}
...
umain(int argc, char **argv)
{
  ...
  8000ea:	83 ec 18             	sub    $0x18,%esp
	forktree("");
  8000ed:	c7 04 24 75 13 80 00 	movl   $0x801375,(%esp)
  8000f4:	e8 a5 ff ff ff       	call   80009e <forktree>
}
  8000f9:	c9                   	leave  
  8000fa:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800101:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800104:	89 75 fc             	mov    %esi,-0x4(%ebp)
  800107:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  800117:	e8 95 0e 00 00       	call   800fb1 <sys_getenvid>
  ...
  800130:	7e 07                	jle    800139 <libmain+0x3e>
		binaryname = argv[0];
  ...
  800140:	e8 a2 ff ff ff       	call   8000e7 <umain>

	// exit gracefully
	exit();
  800145:	e8 0a 00 00 00       	call   800154 <exit>
}
  80014a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80014d:	8b 75 fc             	mov    -0x4(%ebp),%esi
...
exit(void)
{
  ...
  800161:	e8 7f 0e 00 00       	call   800fe5 <sys_env_destroy>
}
  800166:	c9                   	leave  
  800167:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001bc:	e8 1d 0b 00 00       	call   800cde <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800210:	e8 c9 0a 00 00       	call   800cde <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ad:	e8 2e 0e 00 00       	call   8010e0 <__udivdi3>
  ...
  800308:	e8 03 0f 00 00       	call   801210 <__umoddi3>
  80030d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800311:	0f be 80 80 13 80 00 	movsbl 0x801380(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003f5:	ff 24 95 40 14 80 00 	jmp    *0x801440(,%edx,4)
  ...
  8004f7:	c7 44 24 08 9a 13 80 	movl   $0x80139a,0x8(%esp)
  8004fe:	00 
  ...
  800531:	b8 9d 13 80 00       	mov    $0x80139d,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800d44:	00 
  800d45:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800d4c:	00 
  800d4d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d54:	00 
  800d55:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800d5c:	e8 25 03 00 00       	call   801086 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dda:	00 
  800ddb:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800de2:	00 
  800de3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dea:	00 
  800deb:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800df2:	e8 8f 02 00 00       	call   801086 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e38:	00 
  800e39:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800e40:	00 
  800e41:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e48:	00 
  800e49:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800e50:	e8 31 02 00 00       	call   801086 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e96:	00 
  800e97:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800e9e:	00 
  800e9f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea6:	00 
  800ea7:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800eae:	e8 d3 01 00 00       	call   801086 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ef4:	00 
  800ef5:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800efc:	00 
  800efd:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f04:	00 
  800f05:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800f0c:	e8 75 01 00 00       	call   801086 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800f53:	00 
  800f54:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  800f5b:	00 
  800f5c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f63:	00 
  800f64:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  800f6b:	e8 16 01 00 00       	call   801086 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  801018:	00 
  801019:	c7 44 24 08 c4 15 80 	movl   $0x8015c4,0x8(%esp)
  801020:	00 
  801021:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801028:	00 
  801029:	c7 04 24 e1 15 80 00 	movl   $0x8015e1,(%esp)
  801030:	e8 51 00 00 00       	call   801086 <_panic>
...
sfork(void)
{
  ...
  801048:	c7 44 24 08 ef 15 80 	movl   $0x8015ef,0x8(%esp)
  80104f:	00 
  801050:	c7 44 24 04 59 00 00 	movl   $0x59,0x4(%esp)
  801057:	00 
  801058:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  80105f:	e8 22 00 00 00       	call   801086 <_panic>
...
fork(void)
{
  ...
  80106a:	c7 44 24 08 f0 15 80 	movl   $0x8015f0,0x8(%esp)
  801071:	00 
  801072:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801079:	00 
  80107a:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  801081:	e8 00 00 00 00       	call   801086 <_panic>
...
void
_panic(const char *file, int line, const char *fmt, ...)
  80108e:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
  ...
  801091:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  801097:	e8 15 ff ff ff       	call   800fb1 <sys_getenvid>
  80109c:	8b 55 0c             	mov    0xc(%ebp),%edx
  80109f:	89 54 24 10          	mov    %edx,0x10(%esp)
  8010a3:	8b 55 08             	mov    0x8(%ebp),%edx
  8010a6:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8010aa:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8010ae:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010b2:	c7 04 24 10 16 80 00 	movl   $0x801610,(%esp)
  8010b9:	e8 0b f1 ff ff       	call   8001c9 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8010be:	89 74 24 04          	mov    %esi,0x4(%esp)
  8010c2:	8b 45 10             	mov    0x10(%ebp),%eax
  8010c5:	89 04 24             	mov    %eax,(%esp)
  8010c8:	e8 9b f0 ff ff       	call   800168 <vcprintf>
	cprintf("\n");
  8010cd:	c7 04 24 74 13 80 00 	movl   $0x801374,(%esp)
  8010d4:	e8 f0 f0 ff ff       	call   8001c9 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8010d9:	cc                   	int3   
  8010da:	eb fd                	jmp    8010d9 <_panic+0x53>
...
008010e0 <__udivdi3>:
  ...
  801130:	39 f8                	cmp    %edi,%eax
  801132:	77 1c                	ja     801150 <__udivdi3+0x70>
  801134:	0f bd d0             	bsr    %eax,%edx
  801137:	83 f2 1f             	xor    $0x1f,%edx
  80113a:	89 55 f4             	mov    %edx,-0xc(%ebp)
  80113d:	75 39                	jne    801178 <__udivdi3+0x98>
  80113f:	3b 75 f0             	cmp    -0x10(%ebp),%esi
  801142:	0f 86 a0 00 00 00    	jbe    8011e8 <__udivdi3+0x108>
  801148:	39 f8                	cmp    %edi,%eax
  80114a:	0f 82 98 00 00 00    	jb     8011e8 <__udivdi3+0x108>
  801150:	31 ff                	xor    %edi,%edi
  801152:	31 c9                	xor    %ecx,%ecx
  ...
  801176:	c3                   	ret    
  801177:	90                   	nop
  801178:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  80117c:	89 f2                	mov    %esi,%edx
  80117e:	d3 e0                	shl    %cl,%eax
  801180:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801183:	b8 20 00 00 00       	mov    $0x20,%eax
  801188:	2b 45 f4             	sub    -0xc(%ebp),%eax
  80118b:	89 c1                	mov    %eax,%ecx
  80118d:	d3 ea                	shr    %cl,%edx
  80118f:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801193:	0b 55 ec             	or     -0x14(%ebp),%edx
  801196:	d3 e6                	shl    %cl,%esi
  801198:	89 c1                	mov    %eax,%ecx
  80119a:	89 75 e8             	mov    %esi,-0x18(%ebp)
  80119d:	89 fe                	mov    %edi,%esi
  80119f:	d3 ee                	shr    %cl,%esi
  8011a1:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8011a5:	89 55 ec             	mov    %edx,-0x14(%ebp)
  8011a8:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8011ab:	d3 e7                	shl    %cl,%edi
  8011ad:	89 c1                	mov    %eax,%ecx
  8011af:	d3 ea                	shr    %cl,%edx
  8011b1:	09 d7                	or     %edx,%edi
  8011b3:	89 f2                	mov    %esi,%edx
  8011b5:	89 f8                	mov    %edi,%eax
  8011b7:	f7 75 ec             	divl   -0x14(%ebp)
  8011ba:	89 d6                	mov    %edx,%esi
  8011bc:	89 c7                	mov    %eax,%edi
  8011be:	f7 65 e8             	mull   -0x18(%ebp)
  8011c1:	39 d6                	cmp    %edx,%esi
  8011c3:	89 55 ec             	mov    %edx,-0x14(%ebp)
  8011c6:	72 30                	jb     8011f8 <__udivdi3+0x118>
  8011c8:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8011cb:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8011cf:	d3 e2                	shl    %cl,%edx
  8011d1:	39 c2                	cmp    %eax,%edx
  8011d3:	73 05                	jae    8011da <__udivdi3+0xfa>
  8011d5:	3b 75 ec             	cmp    -0x14(%ebp),%esi
  8011d8:	74 1e                	je     8011f8 <__udivdi3+0x118>
  8011da:	89 f9                	mov    %edi,%ecx
  8011dc:	31 ff                	xor    %edi,%edi
  8011de:	e9 71 ff ff ff       	jmp    801154 <__udivdi3+0x74>
  8011e3:	90                   	nop
  8011e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  8011e8:	31 ff                	xor    %edi,%edi
  8011ea:	b9 01 00 00 00       	mov    $0x1,%ecx
  8011ef:	e9 60 ff ff ff       	jmp    801154 <__udivdi3+0x74>
  8011f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  8011f8:	8d 4f ff             	lea    -0x1(%edi),%ecx
...
00801210 <__umoddi3>:
  ...
  801218:	8b 55 14             	mov    0x14(%ebp),%edx
  ...
  80122b:	75 13                	jne    801240 <__umoddi3+0x30>
  80122d:	39 f7                	cmp    %esi,%edi
  80122f:	76 3f                	jbe    801270 <__umoddi3+0x60>
  ...
  80123e:	5d                   	pop    %ebp
  80123f:	c3                   	ret    
  801240:	39 f2                	cmp    %esi,%edx
  801242:	77 4c                	ja     801290 <__umoddi3+0x80>
  801244:	0f bd ca             	bsr    %edx,%ecx
  801247:	83 f1 1f             	xor    $0x1f,%ecx
  80124a:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  80124d:	75 51                	jne    8012a0 <__umoddi3+0x90>
  80124f:	3b 7d f4             	cmp    -0xc(%ebp),%edi
  801252:	0f 87 e0 00 00 00    	ja     801338 <__umoddi3+0x128>
  801258:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80125b:	29 f8                	sub    %edi,%eax
  80125d:	19 d6                	sbb    %edx,%esi
  ...
  801272:	75 0b                	jne    80127f <__umoddi3+0x6f>
  801274:	b8 01 00 00 00       	mov    $0x1,%eax
  801279:	31 d2                	xor    %edx,%edx
  80127b:	f7 f7                	div    %edi
  ...
  80128a:	eb a9                	jmp    801235 <__umoddi3+0x25>
  ...
  8012a0:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8012a4:	d3 e2                	shl    %cl,%edx
  8012a6:	89 55 f4             	mov    %edx,-0xc(%ebp)
  8012a9:	ba 20 00 00 00       	mov    $0x20,%edx
  8012ae:	2b 55 f0             	sub    -0x10(%ebp),%edx
  8012b1:	89 55 ec             	mov    %edx,-0x14(%ebp)
  8012b4:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8012b8:	89 fa                	mov    %edi,%edx
  8012ba:	d3 ea                	shr    %cl,%edx
  8012bc:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8012c0:	0b 55 f4             	or     -0xc(%ebp),%edx
  8012c3:	d3 e7                	shl    %cl,%edi
  8012c5:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8012c9:	89 55 f4             	mov    %edx,-0xc(%ebp)
  8012cc:	89 f2                	mov    %esi,%edx
  8012ce:	89 7d e8             	mov    %edi,-0x18(%ebp)
  ...
  8012e0:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8012e4:	d3 ea                	shr    %cl,%edx
  8012e6:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8012ea:	09 d6                	or     %edx,%esi
  8012ec:	89 f0                	mov    %esi,%eax
  8012ee:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  8012f1:	d3 e7                	shl    %cl,%edi
  8012f3:	89 f2                	mov    %esi,%edx
  8012f5:	f7 75 f4             	divl   -0xc(%ebp)
  8012f8:	89 d6                	mov    %edx,%esi
  8012fa:	f7 65 e8             	mull   -0x18(%ebp)
  8012fd:	39 d6                	cmp    %edx,%esi
  8012ff:	72 2b                	jb     80132c <__umoddi3+0x11c>
  801301:	39 c7                	cmp    %eax,%edi
  801303:	72 23                	jb     801328 <__umoddi3+0x118>
  801305:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801309:	29 c7                	sub    %eax,%edi
  80130b:	19 d6                	sbb    %edx,%esi
  80130d:	89 f0                	mov    %esi,%eax
  80130f:	89 f2                	mov    %esi,%edx
  801311:	d3 ef                	shr    %cl,%edi
  801313:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801317:	d3 e0                	shl    %cl,%eax
  801319:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  80131d:	09 f8                	or     %edi,%eax
  ...
  801326:	5d                   	pop    %ebp
  801327:	c3                   	ret    
  801328:	39 d6                	cmp    %edx,%esi
  80132a:	75 d9                	jne    801305 <__umoddi3+0xf5>
  80132c:	2b 45 e8             	sub    -0x18(%ebp),%eax
  80132f:	1b 55 f4             	sbb    -0xc(%ebp),%edx
  801332:	eb d1                	jmp    801305 <__umoddi3+0xf5>
  801334:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801338:	39 f2                	cmp    %esi,%edx
  80133a:	0f 82 18 ff ff ff    	jb     801258 <__umoddi3+0x48>
  801340:	e9 1d ff ff ff       	jmp    801262 <__umoddi3+0x52>
