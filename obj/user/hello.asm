...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  800039:	c7 04 24 80 12 80 00 	movl   $0x801280,(%esp)
  800040:	e8 e8 00 00 00       	call   80012d <cprintf>
	cprintf("i am environment %08x\n", thisenv->env_id);
  800045:	a1 04 20 80 00       	mov    0x802004,%eax
  80004a:	8b 40 48             	mov    0x48(%eax),%eax
  80004d:	89 44 24 04          	mov    %eax,0x4(%esp)
  800051:	c7 04 24 8e 12 80 00 	movl   $0x80128e,(%esp)
  800058:	e8 d0 00 00 00       	call   80012d <cprintf>
}
  80005d:	c9                   	leave  
  80005e:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80006b:	8b 75 08             	mov    0x8(%ebp),%esi
  80006e:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  ...
  80007b:	e8 91 0e 00 00       	call   800f11 <sys_getenvid>
  ...
  800094:	7e 07                	jle    80009d <libmain+0x3e>
		binaryname = argv[0];
...
exit(void)
{
  ...
  8000c5:	e8 7b 0e 00 00       	call   800f45 <sys_env_destroy>
}
  8000ca:	c9                   	leave  
  8000cb:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800120:	e8 19 0b 00 00       	call   800c3e <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800174:	e8 c5 0a 00 00       	call   800c3e <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800271:	0f be 80 af 12 80 00 	movsbl 0x8012af(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800355:	ff 24 95 80 13 80 00 	jmp    *0x801380(,%edx,4)
  ...
  800457:	c7 44 24 08 c9 12 80 	movl   $0x8012c9,0x8(%esp)
  80045e:	00 
  ...
  800491:	b8 cc 12 80 00       	mov    $0x8012cc,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800ca4:	00 
  800ca5:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800cac:	00 
  800cad:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb4:	00 
  800cb5:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d3a:	00 
  800d3b:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800d42:	00 
  800d43:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d4a:	00 
  800d4b:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d98:	00 
  800d99:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800da0:	00 
  800da1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da8:	00 
  800da9:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800df6:	00 
  800df7:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800dfe:	00 
  800dff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e06:	00 
  800e07:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e54:	00 
  800e55:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800e5c:	00 
  800e5d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e64:	00 
  800e65:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800eb3:	00 
  800eb4:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800ebb:	00 
  800ebc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec3:	00 
  800ec4:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800f78:	00 
  800f79:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800f80:	00 
  800f81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f88:	00 
  800f89:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800fce:	c7 04 24 30 15 80 00 	movl   $0x801530,(%esp)
  800fd5:	e8 53 f1 ff ff       	call   80012d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800fda:	89 74 24 04          	mov    %esi,0x4(%esp)
  800fde:	8b 45 10             	mov    0x10(%ebp),%eax
  800fe1:	89 04 24             	mov    %eax,(%esp)
  800fe4:	e8 e3 f0 ff ff       	call   8000cc <vcprintf>
	cprintf("\n");
  800fe9:	c7 04 24 8c 12 80 00 	movl   $0x80128c,(%esp)
  800ff0:	e8 38 f1 ff ff       	call   80012d <cprintf>
