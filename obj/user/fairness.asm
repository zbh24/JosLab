...
umain(int argc, char **argv)
{
  ...
  800038:	83 ec 20             	sub    $0x20,%esp
	...
	id = sys_getenvid();
  80003b:	e8 31 0f 00 00       	call   800f71 <sys_getenvid>
  ...
  80008f:	c7 04 24 71 13 80 00 	movl   $0x801371,(%esp)
  800096:	e8 f7 00 00 00       	call   800192 <cprintf>
		while (1)
			ipc_send(envs[1].env_id, 0, 0, 0);
  80009b:	bb c4 00 c0 ee       	mov    $0xeec000c4,%ebx
  8000a0:	8b 03                	mov    (%ebx),%eax
  ...
  8000bd:	e8 84 0f 00 00       	call   801046 <ipc_send>
  8000c2:	eb dc                	jmp    8000a0 <umain+0x6d>
...
libmain(int argc, char **argv)
{
  ...
  8000e0:	e8 8c 0e 00 00       	call   800f71 <sys_getenvid>
  ...
  800109:	e8 25 ff ff ff       	call   800033 <umain>
	...
	// exit gracefully
	exit();
  80010e:	e8 0a 00 00 00       	call   80011d <exit>
}
...
exit(void)
{
  ...
  80012a:	e8 76 0e 00 00       	call   800fa5 <sys_env_destroy>
}
  80012f:	c9                   	leave  
  800130:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800166:	c7 04 24 ac 01 80 00 	movl   $0x8001ac,(%esp)
  80016d:	e8 cb 01 00 00       	call   80033d <vprintfmt>
  ...
  800185:	e8 14 0b 00 00       	call   800c9e <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001d9:	e8 c0 0a 00 00       	call   800c9e <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80026d:	e8 6e 0e 00 00       	call   8010e0 <__udivdi3>
  ...
  8002c8:	e8 43 0f 00 00       	call   801210 <__umoddi3>
  8002cd:	89 74 24 04          	mov    %esi,0x4(%esp)
  8002d1:	0f be 80 92 13 80 00 	movsbl 0x801392(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b5:	ff 24 95 60 14 80 00 	jmp    *0x801460(,%edx,4)
  ...
  8004b7:	c7 44 24 08 ac 13 80 	movl   $0x8013ac,0x8(%esp)
  8004be:	00 
  ...
  8004f1:	b8 af 13 80 00       	mov    $0x8013af,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800d04:	00 
  800d05:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800d0c:	00 
  800d0d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d14:	00 
  800d15:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
  800d1c:	e8 69 03 00 00       	call   80108a <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d9a:	00 
  800d9b:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800da2:	00 
  800da3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800daa:	00 
  800dab:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
  800db2:	e8 d3 02 00 00       	call   80108a <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e10:	e8 75 02 00 00       	call   80108a <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e56:	00 
  800e57:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800e5e:	00 
  800e5f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e66:	00 
  800e67:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
  800e6e:	e8 17 02 00 00       	call   80108a <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800eb4:	00 
  800eb5:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800ebc:	00 
  800ebd:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec4:	00 
  800ec5:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
  800ecc:	e8 b9 01 00 00       	call   80108a <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800f2b:	e8 5a 01 00 00       	call   80108a <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800fd8:	00 
  800fd9:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800fe0:	00 
  800fe1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fe8:	00 
  800fe9:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
  800ff0:	e8 95 00 00 00       	call   80108a <_panic>
...
ipc_find_env(enum EnvType type)
{
  ...
  801005:	8b 4d 08             	mov    0x8(%ebp),%ecx
	int i;
	for (i = 0; i < NENV; i++)
		if (envs[i].env_type == type)
  801008:	8b 15 50 00 c0 ee    	mov    0xeec00050,%edx
  80100e:	b8 01 00 00 00       	mov    $0x1,%eax
  801013:	39 ca                	cmp    %ecx,%edx
  801015:	75 04                	jne    80101b <ipc_find_env+0x19>
  801017:	b0 00                	mov    $0x0,%al
  801019:	eb 0f                	jmp    80102a <ipc_find_env+0x28>
  80101b:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80101e:	81 c2 50 00 c0 ee    	add    $0xeec00050,%edx
  801024:	8b 12                	mov    (%edx),%edx
  801026:	39 ca                	cmp    %ecx,%edx
  801028:	75 0c                	jne    801036 <ipc_find_env+0x34>
			return envs[i].env_id;
  80102a:	6b c0 7c             	imul   $0x7c,%eax,%eax
  80102d:	05 48 00 c0 ee       	add    $0xeec00048,%eax
  801032:	8b 00                	mov    (%eax),%eax
  801034:	eb 0e                	jmp    801044 <ipc_find_env+0x42>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  801036:	83 c0 01             	add    $0x1,%eax
  801039:	3d 00 04 00 00       	cmp    $0x400,%eax
  80103e:	75 db                	jne    80101b <ipc_find_env+0x19>
  801040:	66 b8 00 00          	mov    $0x0,%ax
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80104c:	c7 44 24 08 0f 16 80 	movl   $0x80160f,0x8(%esp)
  801053:	00 
  801054:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  80105b:	00 
  80105c:	c7 04 24 28 16 80 00 	movl   $0x801628,(%esp)
  801063:	e8 22 00 00 00       	call   80108a <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80106e:	c7 44 24 08 32 16 80 	movl   $0x801632,0x8(%esp)
  801075:	00 
  801076:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  80107d:	00 
  80107e:	c7 04 24 28 16 80 00 	movl   $0x801628,(%esp)
  801085:	e8 00 00 00 00       	call   80108a <_panic>
...
void
_panic(const char *file, int line, const char *fmt, ...)
  801092:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
  ...
  801095:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  80109b:	e8 d1 fe ff ff       	call   800f71 <sys_getenvid>
  8010a0:	8b 55 0c             	mov    0xc(%ebp),%edx
  8010a3:	89 54 24 10          	mov    %edx,0x10(%esp)
  ...
  8010b6:	c7 04 24 4c 16 80 00 	movl   $0x80164c,(%esp)
  8010bd:	e8 d0 f0 ff ff       	call   800192 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8010c2:	89 74 24 04          	mov    %esi,0x4(%esp)
  8010c6:	8b 45 10             	mov    0x10(%ebp),%eax
  8010c9:	89 04 24             	mov    %eax,(%esp)
  8010cc:	e8 60 f0 ff ff       	call   800131 <vcprintf>
	cprintf("\n");
  8010d1:	c7 04 24 6f 13 80 00 	movl   $0x80136f,(%esp)
  8010d8:	e8 b5 f0 ff ff       	call   800192 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8010dd:	cc                   	int3   
  8010de:	eb fd                	jmp    8010dd <_panic+0x53>
