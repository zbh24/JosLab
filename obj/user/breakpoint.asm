...
libmain(int argc, char **argv)
{
  ...
  800055:	e8 53 03 00 00       	call   8003ad <sys_getenvid>
...
exit(void)
{
  ...
  80009f:	e8 3d 03 00 00       	call   8003e1 <sys_env_destroy>
}
  8000a4:	c9                   	leave  
  8000a5:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000b3:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
...
sys_cgetc(void)
{
  ...
  8000cb:	8b 1c 24             	mov    (%esp),%ebx
  8000ce:	8b 74 24 04          	mov    0x4(%esp),%esi
  8000d2:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8000d6:	89 ec                	mov    %ebp,%esp
  8000d8:	5d                   	pop    %ebp
  8000d9:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000e0:	89 1c 24             	mov    %ebx,(%esp)
  8000e3:	89 74 24 04          	mov    %esi,0x4(%esp)
  8000e7:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000fe:	8b 1c 24             	mov    (%esp),%ebx
  800101:	8b 74 24 04          	mov    0x4(%esp),%esi
  800105:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800109:	89 ec                	mov    %ebp,%esp
  80010b:	5d                   	pop    %ebp
  80010c:	c3                   	ret    

0080010d <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  800110:	83 ec 38             	sub    $0x38,%esp
  800113:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800116:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800119:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800121:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  800133:	7e 28                	jle    80015d <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  800135:	89 44 24 10          	mov    %eax,0x10(%esp)
  800139:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800140:	00 
  800141:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  800148:	00 
  800149:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800150:	00 
  800151:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  800158:	e8 e1 02 00 00       	call   80043e <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80015d:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800160:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800163:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800166:	89 ec                	mov    %ebp,%esp
  800168:	5d                   	pop    %ebp
  800169:	c3                   	ret    

0080016a <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800173:	89 74 24 04          	mov    %esi,0x4(%esp)
  800177:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800185:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800193:	8b 1c 24             	mov    (%esp),%ebx
  800196:	8b 74 24 04          	mov    0x4(%esp),%esi
  80019a:	8b 7c 24 08          	mov    0x8(%esp),%edi
  80019e:	89 ec                	mov    %ebp,%esp
  8001a0:	5d                   	pop    %ebp
  8001a1:	c3                   	ret    

008001a2 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8001a5:	83 ec 38             	sub    $0x38,%esp
  8001a8:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8001ab:	89 75 f8             	mov    %esi,-0x8(%ebp)
  ...
  8001c9:	7e 28                	jle    8001f3 <sys_env_set_pgfault_upcall+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001cb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001cf:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8001d6:	00 
  8001d7:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  8001de:	00 
  8001df:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001e6:	00 
  8001e7:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  8001ee:	e8 4b 02 00 00       	call   80043e <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800214:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  800227:	7e 28                	jle    800251 <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800229:	89 44 24 10          	mov    %eax,0x10(%esp)
  80022d:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800234:	00 
  800235:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  80023c:	00 
  80023d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800244:	00 
  800245:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  80024c:	e8 ed 01 00 00       	call   80043e <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800251:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800254:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800257:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80025a:	89 ec                	mov    %ebp,%esp
  80025c:	5d                   	pop    %ebp
  80025d:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800261:	83 ec 38             	sub    $0x38,%esp
  800264:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800267:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80026a:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800285:	7e 28                	jle    8002af <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800287:	89 44 24 10          	mov    %eax,0x10(%esp)
  80028b:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800292:	00 
  800293:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  80029a:	00 
  80029b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a2:	00 
  8002a3:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  8002aa:	e8 8f 01 00 00       	call   80043e <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002af:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002b2:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002b5:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002b8:	89 ec                	mov    %ebp,%esp
  8002ba:	5d                   	pop    %ebp
  8002bb:	c3                   	ret    
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002bf:	83 ec 38             	sub    $0x38,%esp
  8002c2:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002c5:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8002c8:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  8002cb:	b8 05 00 00 00       	mov    $0x5,%eax
  8002d0:	8b 75 18             	mov    0x18(%ebp),%esi
  8002d3:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  8002e3:	7e 28                	jle    80030d <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002e5:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002e9:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8002f0:	00 
  8002f1:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  8002f8:	00 
  8002f9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800300:	00 
  800301:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  800308:	e8 31 01 00 00       	call   80043e <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80030d:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800310:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800313:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800316:	89 ec                	mov    %ebp,%esp
  800318:	5d                   	pop    %ebp
  800319:	c3                   	ret    

0080031a <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80031d:	83 ec 38             	sub    $0x38,%esp
  800320:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800323:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800326:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800342:	7e 28                	jle    80036c <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  800344:	89 44 24 10          	mov    %eax,0x10(%esp)
  800348:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80034f:	00 
  800350:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  800357:	00 
  800358:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80035f:	00 
  800360:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  800367:	e8 d2 00 00 00       	call   80043e <_panic>
...
sys_yield(void)
{
  ...
  800386:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80038f:	b8 0a 00 00 00       	mov    $0xa,%eax
  800394:	89 d1                	mov    %edx,%ecx
...
sys_yield(void)
{
  ...
  80039e:	8b 1c 24             	mov    (%esp),%ebx
  8003a1:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003a5:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003a9:	89 ec                	mov    %ebp,%esp
  8003ab:	5d                   	pop    %ebp
  8003ac:	c3                   	ret    

008003ad <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  8003ba:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003c3:	b8 02 00 00 00       	mov    $0x2,%eax
  8003c8:	89 d1                	mov    %edx,%ecx
  8003ca:	89 d3                	mov    %edx,%ebx
...
sys_getenvid(void)
{
  ...
  8003d2:	8b 1c 24             	mov    (%esp),%ebx
  8003d5:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003d9:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003dd:	89 ec                	mov    %ebp,%esp
  8003df:	5d                   	pop    %ebp
  8003e0:	c3                   	ret    

008003e1 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  8003e4:	83 ec 38             	sub    $0x38,%esp
  8003e7:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8003ea:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8003ed:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003f5:	b8 03 00 00 00       	mov    $0x3,%eax
  8003fa:	8b 55 08             	mov    0x8(%ebp),%edx
  8003fd:	89 cb                	mov    %ecx,%ebx
  8003ff:	89 cf                	mov    %ecx,%edi
  ...
  800407:	7e 28                	jle    800431 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  800409:	89 44 24 10          	mov    %eax,0x10(%esp)
  80040d:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800414:	00 
  800415:	c7 44 24 08 6a 12 80 	movl   $0x80126a,0x8(%esp)
  80041c:	00 
  80041d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800424:	00 
  800425:	c7 04 24 87 12 80 00 	movl   $0x801287,(%esp)
  80042c:	e8 0d 00 00 00       	call   80043e <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800431:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800434:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
void
_panic(const char *file, int line, const char *fmt, ...)
  800446:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
  ...
  800449:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  80044f:	e8 59 ff ff ff       	call   8003ad <sys_getenvid>
  800454:	8b 55 0c             	mov    0xc(%ebp),%edx
  800457:	89 54 24 10          	mov    %edx,0x10(%esp)
  80045b:	8b 55 08             	mov    0x8(%ebp),%edx
  80045e:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800462:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800466:	89 44 24 04          	mov    %eax,0x4(%esp)
  80046a:	c7 04 24 98 12 80 00 	movl   $0x801298,(%esp)
  800471:	e8 7f 00 00 00       	call   8004f5 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800476:	89 74 24 04          	mov    %esi,0x4(%esp)
  80047a:	8b 45 10             	mov    0x10(%ebp),%eax
  80047d:	89 04 24             	mov    %eax,(%esp)
  800480:	e8 0f 00 00 00       	call   800494 <vcprintf>
	cprintf("\n");
  800485:	c7 04 24 bc 12 80 00 	movl   $0x8012bc,(%esp)
  80048c:	e8 64 00 00 00       	call   8004f5 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800491:	cc                   	int3   
  800492:	eb fd                	jmp    800491 <_panic+0x53>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800497:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  8004bb:	89 44 24 08          	mov    %eax,0x8(%esp)
  8004bf:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  8004c5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004c9:	c7 04 24 0f 05 80 00 	movl   $0x80050f,(%esp)
  8004d0:	e8 d8 01 00 00       	call   8006ad <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8004d5:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8004db:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004df:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8004e5:	89 04 24             	mov    %eax,(%esp)
  8004e8:	e8 ed fb ff ff       	call   8000da <sys_cputs>

	return b.cnt;
}
  8004ed:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  8004f3:	c9                   	leave  
  8004f4:	c3                   	ret    
...
int
cprintf(const char *fmt, ...)
  8004fb:	8d 45 0c             	lea    0xc(%ebp),%eax
{
	va_list ap;
	int cnt;
  ...
  800508:	e8 87 ff ff ff       	call   800494 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  800512:	53                   	push   %ebx
  800513:	83 ec 14             	sub    $0x14,%esp
  800516:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  800519:	8b 03                	mov    (%ebx),%eax
  80051b:	8b 55 08             	mov    0x8(%ebp),%edx
  80051e:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800522:	83 c0 01             	add    $0x1,%eax
  800525:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800527:	3d ff 00 00 00       	cmp    $0xff,%eax
  80052c:	75 19                	jne    800547 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80052e:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800535:	00 
  800536:	8d 43 08             	lea    0x8(%ebx),%eax
  800539:	89 04 24             	mov    %eax,(%esp)
  80053c:	e8 99 fb ff ff       	call   8000da <sys_cputs>
		b->idx = 0;
  800541:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800547:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  80054b:	83 c4 14             	add    $0x14,%esp
  80054e:	5b                   	pop    %ebx
  80054f:	5d                   	pop    %ebp
  800550:	c3                   	ret    
