...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 20 80 00 60 	movl   $0x801260,0x802000
  800040:	12 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 42 03 00 00       	call   80038a <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  800050:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800053:	89 75 fc             	mov    %esi,-0x4(%ebp)
  800056:	8b 75 08             	mov    0x8(%ebp),%esi
  800059:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  ...
  800066:	e8 53 03 00 00       	call   8003be <sys_getenvid>
  ...
  80007f:	7e 07                	jle    800088 <libmain+0x3e>
		binaryname = argv[0];
...
exit(void)
{
  ...
  8000b0:	e8 3d 03 00 00       	call   8003f2 <sys_env_destroy>
}
  8000b5:	c9                   	leave  
  8000b6:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000c4:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
...
sys_cputs(const char *s, size_t len)
{
  ...
  80010f:	8b 1c 24             	mov    (%esp),%ebx
  800112:	8b 74 24 04          	mov    0x4(%esp),%esi
  800116:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  800121:	83 ec 38             	sub    $0x38,%esp
  800124:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800127:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80012a:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800132:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  800144:	7e 28                	jle    80016e <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  800146:	89 44 24 10          	mov    %eax,0x10(%esp)
  80014a:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800151:	00 
  800152:	c7 44 24 08 6f 12 80 	movl   $0x80126f,0x8(%esp)
  800159:	00 
  80015a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800161:	00 
  800162:	c7 04 24 8c 12 80 00 	movl   $0x80128c,(%esp)
  800169:	e8 e1 02 00 00       	call   80044f <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80016e:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800171:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800174:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800177:	89 ec                	mov    %ebp,%esp
  800179:	5d                   	pop    %ebp
  80017a:	c3                   	ret    

0080017b <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800181:	89 1c 24             	mov    %ebx,(%esp)
  800184:	89 74 24 04          	mov    %esi,0x4(%esp)
  800188:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001a4:	8b 1c 24             	mov    (%esp),%ebx
  8001a7:	8b 74 24 04          	mov    0x4(%esp),%esi
  8001ab:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8001af:	89 ec                	mov    %ebp,%esp
  8001b1:	5d                   	pop    %ebp
  8001b2:	c3                   	ret    

008001b3 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8001b6:	83 ec 38             	sub    $0x38,%esp
  8001b9:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8001bc:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8001bf:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8001da:	7e 28                	jle    800204 <sys_env_set_pgfault_upcall+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001dc:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001e0:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8001e7:	00 
  8001e8:	c7 44 24 08 6f 12 80 	movl   $0x80126f,0x8(%esp)
  8001ef:	00 
  8001f0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001f7:	00 
  8001f8:	c7 04 24 8c 12 80 00 	movl   $0x80128c,(%esp)
  8001ff:	e8 4b 02 00 00       	call   80044f <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800238:	7e 28                	jle    800262 <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  80023a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80023e:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800245:	00 
  800246:	c7 44 24 08 6f 12 80 	movl   $0x80126f,0x8(%esp)
  80024d:	00 
  80024e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800255:	00 
  800256:	c7 04 24 8c 12 80 00 	movl   $0x80128c,(%esp)
  80025d:	e8 ed 01 00 00       	call   80044f <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800262:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800265:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800268:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80026b:	89 ec                	mov    %ebp,%esp
  80026d:	5d                   	pop    %ebp
  80026e:	c3                   	ret    

0080026f <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800272:	83 ec 38             	sub    $0x38,%esp
  800275:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800278:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80027b:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800296:	7e 28                	jle    8002c0 <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800298:	89 44 24 10          	mov    %eax,0x10(%esp)
  80029c:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8002a3:	00 
  8002a4:	c7 44 24 08 6f 12 80 	movl   $0x80126f,0x8(%esp)
  8002ab:	00 
  8002ac:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b3:	00 
  8002b4:	c7 04 24 8c 12 80 00 	movl   $0x80128c,(%esp)
  8002bb:	e8 8f 01 00 00       	call   80044f <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c0:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002c3:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002c6:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002c9:	89 ec                	mov    %ebp,%esp
  8002cb:	5d                   	pop    %ebp
  8002cc:	c3                   	ret    

008002cd <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002d0:	83 ec 38             	sub    $0x38,%esp
  8002d3:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002d6:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8002d9:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  8002dc:	b8 05 00 00 00       	mov    $0x5,%eax
  ...
  8002f4:	7e 28                	jle    80031e <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002f6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002fa:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800301:	00 
  800302:	c7 44 24 08 6f 12 80 	movl   $0x80126f,0x8(%esp)
  800309:	00 
  80030a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800311:	00 
  800312:	c7 04 24 8c 12 80 00 	movl   $0x80128c,(%esp)
  800319:	e8 31 01 00 00       	call   80044f <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800353:	7e 28                	jle    80037d <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  800355:	89 44 24 10          	mov    %eax,0x10(%esp)
  800359:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800360:	00 
  800361:	c7 44 24 08 6f 12 80 	movl   $0x80126f,0x8(%esp)
  800368:	00 
  800369:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800370:	00 
  800371:	c7 04 24 8c 12 80 00 	movl   $0x80128c,(%esp)
  800378:	e8 d2 00 00 00       	call   80044f <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80037d:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800380:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800383:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_yield(void)
{
  ...
  800390:	89 1c 24             	mov    %ebx,(%esp)
  800393:	89 74 24 04          	mov    %esi,0x4(%esp)
  800397:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003a0:	b8 0a 00 00 00       	mov    $0xa,%eax
  8003a5:	89 d1                	mov    %edx,%ecx
  8003a7:	89 d3                	mov    %edx,%ebx
...
sys_yield(void)
{
  ...
  8003af:	8b 1c 24             	mov    (%esp),%ebx
  8003b2:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003b6:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003ba:	89 ec                	mov    %ebp,%esp
  8003bc:	5d                   	pop    %ebp
  8003bd:	c3                   	ret    

008003be <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  8003c4:	89 1c 24             	mov    %ebx,(%esp)
  8003c7:	89 74 24 04          	mov    %esi,0x4(%esp)
  8003cb:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003d4:	b8 02 00 00 00       	mov    $0x2,%eax
  8003d9:	89 d1                	mov    %edx,%ecx
  8003db:	89 d3                	mov    %edx,%ebx
  8003dd:	89 d7                	mov    %edx,%edi
...
sys_getenvid(void)
{
  ...
  8003e3:	8b 1c 24             	mov    (%esp),%ebx
  8003e6:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003ea:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003ee:	89 ec                	mov    %ebp,%esp
  8003f0:	5d                   	pop    %ebp
  8003f1:	c3                   	ret    

008003f2 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  8003f5:	83 ec 38             	sub    $0x38,%esp
  8003f8:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8003fb:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8003fe:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800406:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  800418:	7e 28                	jle    800442 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80041a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80041e:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800425:	00 
  800426:	c7 44 24 08 6f 12 80 	movl   $0x80126f,0x8(%esp)
  80042d:	00 
  80042e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800435:	00 
  800436:	c7 04 24 8c 12 80 00 	movl   $0x80128c,(%esp)
  80043d:	e8 0d 00 00 00       	call   80044f <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800442:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800445:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800448:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
void
_panic(const char *file, int line, const char *fmt, ...)
  800457:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
  ...
  80045a:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800460:	e8 59 ff ff ff       	call   8003be <sys_getenvid>
  800465:	8b 55 0c             	mov    0xc(%ebp),%edx
  800468:	89 54 24 10          	mov    %edx,0x10(%esp)
  80046c:	8b 55 08             	mov    0x8(%ebp),%edx
  80046f:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800473:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800477:	89 44 24 04          	mov    %eax,0x4(%esp)
  80047b:	c7 04 24 9c 12 80 00 	movl   $0x80129c,(%esp)
  800482:	e8 7f 00 00 00       	call   800506 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800487:	89 74 24 04          	mov    %esi,0x4(%esp)
  80048b:	8b 45 10             	mov    0x10(%ebp),%eax
  80048e:	89 04 24             	mov    %eax,(%esp)
  800491:	e8 0f 00 00 00       	call   8004a5 <vcprintf>
	cprintf("\n");
  800496:	c7 04 24 c0 12 80 00 	movl   $0x8012c0,(%esp)
  80049d:	e8 64 00 00 00       	call   800506 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8004a2:	cc                   	int3   
  8004a3:	eb fd                	jmp    8004a2 <_panic+0x53>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004a8:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;

	b.idx = 0;
  8004ae:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  8004b5:	00 00 00 
	b.cnt = 0;
  8004b8:	c7 85 f4 fe ff ff 00 	movl   $0x0,-0x10c(%ebp)
  8004bf:	00 00 00 
  ...
  8004da:	c7 04 24 20 05 80 00 	movl   $0x800520,(%esp)
  8004e1:	e8 d7 01 00 00       	call   8006bd <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8004e6:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8004ec:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004f0:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8004f6:	89 04 24             	mov    %eax,(%esp)
  8004f9:	e8 ed fb ff ff       	call   8000eb <sys_cputs>
  ...
  80050c:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  800519:	e8 87 ff ff ff       	call   8004a5 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  800527:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  80052a:	8b 03                	mov    (%ebx),%eax
  80052c:	8b 55 08             	mov    0x8(%ebp),%edx
  80052f:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800533:	83 c0 01             	add    $0x1,%eax
  800536:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800538:	3d ff 00 00 00       	cmp    $0xff,%eax
  80053d:	75 19                	jne    800558 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80053f:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800546:	00 
  800547:	8d 43 08             	lea    0x8(%ebx),%eax
  80054a:	89 04 24             	mov    %eax,(%esp)
  80054d:	e8 99 fb ff ff       	call   8000eb <sys_cputs>
		b->idx = 0;
  800552:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800558:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  80055c:	83 c4 14             	add    $0x14,%esp
  80055f:	5b                   	pop    %ebx
  800560:	5d                   	pop    %ebp
  800561:	c3                   	ret    
  800562:	66 90                	xchg   %ax,%ax
  800564:	66 90                	xchg   %ax,%ax
  800566:	66 90                	xchg   %ax,%ax
  800568:	66 90                	xchg   %ax,%ax
  80056a:	66 90                	xchg   %ax,%ax
  80056c:	66 90                	xchg   %ax,%ax
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800651:	0f be 80 c2 12 80 00 	movsbl 0x8012c2(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800817:	c7 44 24 08 d3 12 80 	movl   $0x8012d3,0x8(%esp)
  80081e:	00 
  ...
  800837:	c7 44 24 08 dc 12 80 	movl   $0x8012dc,0x8(%esp)
  80083e:	00 
  ...
  800871:	b8 df 12 80 00       	mov    $0x8012df,%eax
