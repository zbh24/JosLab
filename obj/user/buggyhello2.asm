...
libmain(int argc, char **argv)
{
  ...
  80005f:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	thisenv = 0;
  800062:	c7 05 08 20 80 00 00 	movl   $0x0,0x802008
  800069:	00 00 00 
	thisenv = &envs[ENVX(sys_getenvid())];
  80006c:	e8 53 03 00 00       	call   8003c4 <sys_getenvid>
  800071:	25 ff 03 00 00       	and    $0x3ff,%eax
  800076:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800079:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80007e:	a3 08 20 80 00       	mov    %eax,0x802008
...
exit(void)
{
  ...
  8000b6:	e8 3d 03 00 00       	call   8003f8 <sys_env_destroy>
}
  8000bb:	c9                   	leave  
  8000bc:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000ca:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
...
sys_cgetc(void)
{
  ...
  8000e2:	8b 1c 24             	mov    (%esp),%ebx
  8000e5:	8b 74 24 04          	mov    0x4(%esp),%esi
  8000e9:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8000ed:	89 ec                	mov    %ebp,%esp
  8000ef:	5d                   	pop    %ebp
  8000f0:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000fe:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_cputs(const char *s, size_t len)
{
  ...
  800118:	8b 74 24 04          	mov    0x4(%esp),%esi
  80011c:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800120:	89 ec                	mov    %ebp,%esp
  800122:	5d                   	pop    %ebp
  800123:	c3                   	ret    

00800124 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  800127:	83 ec 38             	sub    $0x38,%esp
  80012a:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80012d:	89 75 f8             	mov    %esi,-0x8(%ebp)
  ...
  80014a:	7e 28                	jle    800174 <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80014c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800150:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800157:	00 
  800158:	c7 44 24 08 78 12 80 	movl   $0x801278,0x8(%esp)
  80015f:	00 
  800160:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800167:	00 
  800168:	c7 04 24 95 12 80 00 	movl   $0x801295,(%esp)
  80016f:	e8 e1 02 00 00       	call   800455 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800174:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800177:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80017a:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80017d:	89 ec                	mov    %ebp,%esp
  80017f:	5d                   	pop    %ebp
  800180:	c3                   	ret    

00800181 <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80018e:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
008001b9 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8001cd:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8001e0:	7e 28                	jle    80020a <sys_env_set_pgfault_upcall+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001e2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001e6:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8001ed:	00 
  8001ee:	c7 44 24 08 78 12 80 	movl   $0x801278,0x8(%esp)
  8001f5:	00 
  8001f6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fd:	00 
  8001fe:	c7 04 24 95 12 80 00 	movl   $0x801295,(%esp)
  800205:	e8 4b 02 00 00       	call   800455 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80023e:	7e 28                	jle    800268 <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800240:	89 44 24 10          	mov    %eax,0x10(%esp)
  800244:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80024b:	00 
  80024c:	c7 44 24 08 78 12 80 	movl   $0x801278,0x8(%esp)
  800253:	00 
  800254:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025b:	00 
  80025c:	c7 04 24 95 12 80 00 	movl   $0x801295,(%esp)
  800263:	e8 ed 01 00 00       	call   800455 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800268:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80026b:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80026e:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800271:	89 ec                	mov    %ebp,%esp
  800273:	5d                   	pop    %ebp
  800274:	c3                   	ret    

00800275 <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800278:	83 ec 38             	sub    $0x38,%esp
  80027b:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80027e:	89 75 f8             	mov    %esi,-0x8(%ebp)
  ...
  800289:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  80029c:	7e 28                	jle    8002c6 <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  80029e:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002a2:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8002a9:	00 
  8002aa:	c7 44 24 08 78 12 80 	movl   $0x801278,0x8(%esp)
  8002b1:	00 
  8002b2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b9:	00 
  8002ba:	c7 04 24 95 12 80 00 	movl   $0x801295,(%esp)
  8002c1:	e8 8f 01 00 00       	call   800455 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c6:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002c9:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002cc:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002cf:	89 ec                	mov    %ebp,%esp
  8002d1:	5d                   	pop    %ebp
  8002d2:	c3                   	ret    

008002d3 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002d6:	83 ec 38             	sub    $0x38,%esp
  8002d9:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002dc:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8002df:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  8002e2:	b8 05 00 00 00       	mov    $0x5,%eax
  8002e7:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  8002fa:	7e 28                	jle    800324 <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002fc:	89 44 24 10          	mov    %eax,0x10(%esp)
  800300:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800307:	00 
  800308:	c7 44 24 08 78 12 80 	movl   $0x801278,0x8(%esp)
  80030f:	00 
  800310:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800317:	00 
  800318:	c7 04 24 95 12 80 00 	movl   $0x801295,(%esp)
  80031f:	e8 31 01 00 00       	call   800455 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800324:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800327:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800334:	83 ec 38             	sub    $0x38,%esp
  800337:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80033a:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80033d:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800359:	7e 28                	jle    800383 <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  80035b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80035f:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800366:	00 
  800367:	c7 44 24 08 78 12 80 	movl   $0x801278,0x8(%esp)
  80036e:	00 
  80036f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800376:	00 
  800377:	c7 04 24 95 12 80 00 	movl   $0x801295,(%esp)
  80037e:	e8 d2 00 00 00       	call   800455 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800383:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800386:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
sys_yield(void)
{
  ...
  80039d:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003a6:	b8 0a 00 00 00       	mov    $0xa,%eax
...
sys_yield(void)
{
  ...
  8003b5:	8b 1c 24             	mov    (%esp),%ebx
  8003b8:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003bc:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003c0:	89 ec                	mov    %ebp,%esp
  8003c2:	5d                   	pop    %ebp
  8003c3:	c3                   	ret    

008003c4 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  8003d1:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003da:	b8 02 00 00 00       	mov    $0x2,%eax
...
sys_getenvid(void)
{
  ...
  8003e9:	8b 1c 24             	mov    (%esp),%ebx
  8003ec:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003f0:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003f4:	89 ec                	mov    %ebp,%esp
  8003f6:	5d                   	pop    %ebp
  8003f7:	c3                   	ret    

008003f8 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  8003fb:	83 ec 38             	sub    $0x38,%esp
  8003fe:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800401:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800404:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80040c:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  80041e:	7e 28                	jle    800448 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  800420:	89 44 24 10          	mov    %eax,0x10(%esp)
  800424:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80042b:	00 
  80042c:	c7 44 24 08 78 12 80 	movl   $0x801278,0x8(%esp)
  800433:	00 
  800434:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80043b:	00 
  80043c:	c7 04 24 95 12 80 00 	movl   $0x801295,(%esp)
  800443:	e8 0d 00 00 00       	call   800455 <_panic>
...
void
_panic(const char *file, int line, const char *fmt, ...)
  80045d:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
  ...
  800460:	8b 1d 04 20 80 00    	mov    0x802004,%ebx
  800466:	e8 59 ff ff ff       	call   8003c4 <sys_getenvid>
  80046b:	8b 55 0c             	mov    0xc(%ebp),%edx
  80046e:	89 54 24 10          	mov    %edx,0x10(%esp)
  800472:	8b 55 08             	mov    0x8(%ebp),%edx
  800475:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800479:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80047d:	89 44 24 04          	mov    %eax,0x4(%esp)
  800481:	c7 04 24 a4 12 80 00 	movl   $0x8012a4,(%esp)
  800488:	e8 7f 00 00 00       	call   80050c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80048d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800491:	8b 45 10             	mov    0x10(%ebp),%eax
  800494:	89 04 24             	mov    %eax,(%esp)
  800497:	e8 0f 00 00 00       	call   8004ab <vcprintf>
	cprintf("\n");
  80049c:	c7 04 24 6c 12 80 00 	movl   $0x80126c,(%esp)
  8004a3:	e8 64 00 00 00       	call   80050c <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8004a8:	cc                   	int3   
  8004a9:	eb fd                	jmp    8004a8 <_panic+0x53>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004e0:	c7 04 24 26 05 80 00 	movl   $0x800526,(%esp)
  8004e7:	e8 d1 01 00 00       	call   8006bd <vprintfmt>
  ...
  8004ff:	e8 ed fb ff ff       	call   8000f1 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800529:	53                   	push   %ebx
  80052a:	83 ec 14             	sub    $0x14,%esp
  80052d:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  800530:	8b 03                	mov    (%ebx),%eax
  800532:	8b 55 08             	mov    0x8(%ebp),%edx
  800535:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800539:	83 c0 01             	add    $0x1,%eax
  80053c:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  80053e:	3d ff 00 00 00       	cmp    $0xff,%eax
  800543:	75 19                	jne    80055e <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800545:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  80054c:	00 
  80054d:	8d 43 08             	lea    0x8(%ebx),%eax
  800550:	89 04 24             	mov    %eax,(%esp)
  800553:	e8 99 fb ff ff       	call   8000f1 <sys_cputs>
		b->idx = 0;
  800558:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  80055e:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  800562:	83 c4 14             	add    $0x14,%esp
  800565:	5b                   	pop    %ebx
  800566:	5d                   	pop    %ebp
  800567:	c3                   	ret    
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800651:	0f be 80 c8 12 80 00 	movsbl 0x8012c8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800817:	c7 44 24 08 d9 12 80 	movl   $0x8012d9,0x8(%esp)
  80081e:	00 
  ...
  800837:	c7 44 24 08 e2 12 80 	movl   $0x8012e2,0x8(%esp)
  80083e:	00 
  ...
  800871:	b8 e5 12 80 00       	mov    $0x8012e5,%eax
